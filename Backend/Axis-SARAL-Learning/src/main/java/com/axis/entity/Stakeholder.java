...
public class Stakeholder {
    ...
    @Column(name = "StakeHolder_Profile", nullable=false)
    public String stakeholderprofile;
	...
	public String getStakeholderprofile() {
		return stakeholderprofile;
	}



	public void setStakeholderprofile(String stakeholderprofile) {
		this.stakeholderprofile = stakeholderprofile;
	}



	public Stakeholder(String stakeholderId, String stakeholderName, String stakeholderEmail, Long stakeholderMobileNo,
			String stakeholderPosition, String stakeholderprofile) {
		super();
		this.stakeholderId = stakeholderId;
		this.stakeholderName = stakeholderName;
		this.stakeholderEmail = stakeholderEmail;
