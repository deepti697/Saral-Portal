...
public class NewsFeed {
    ...
    public NewsFeed(long newsFeedId, String newsName, String newsImageUrl, String newsDescription, String newsDate,
	...
	public String toString() {
		return "NewsFeed [newsFeedId=" + newsFeedId + ", newsName=" + newsName + ", newsDate=" + newsDate
				+ ", newsImageUrl=" + newsImageUrl + ", newsDescription=" + newsDescription + ", comments=" + comments
				+ "]";
	}
