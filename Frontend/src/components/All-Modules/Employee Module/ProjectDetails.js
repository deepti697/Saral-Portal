    ...
    <>
      ...
      <div>
        <Card>
          ...
          <Card.Body  className="projectdetailnav"  style={{ display: projectDetailsChange ? "block" : "none",borderRadius:"15px" }} >
